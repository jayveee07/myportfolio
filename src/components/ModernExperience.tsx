          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              <motion.div
                ...
                className={`relative flex-col items-center gap-8 ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}
              >
                {/* Content Card */}
                <div className={`flex-1 w-full max-w-2xl ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'}`}>
